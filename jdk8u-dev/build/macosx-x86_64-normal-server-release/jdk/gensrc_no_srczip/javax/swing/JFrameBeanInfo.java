...
public class JFrameBeanInfo extends javax.swing.SwingBeanInfoBase {
    private static final Class classJFrame = javax.swing.JFrame.class;

    /**
     * @return a JFrame BeanDescriptor
     */
    public BeanDescriptor getBeanDescriptor() {
        return BeanInfoUtils.createBeanDescriptor(classJFrame,
                                                  new Object[] {
                BeanInfoUtils.PREFERRED, Boolean.TRUE,
                              "containerDelegate", "getContentPane",
                               "isContainer", Boolean.TRUE,
                 
                    BeanInfoUtils.SHORTDESCRIPTION, "A toplevel window which can be minimized to an icon."
        });
    }
    ...
    private PropertyDescriptor createPropertyDescriptor(String name, Object[] args) {
        return BeanInfoUtils.createPropertyDescriptor(classJFrame, name, args);
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
		...
		Object[] defaultCloseOperationEnumeration = new Object[] { 
			...
			"EXIT_ON_CLOSE" ,   new Integer(WindowConstants.EXIT_ON_CLOSE), "WindowConstants.EXIT_ON_CLOSE",
        ...
        return new PropertyDescriptor[] {
             ...
             createPropertyDescriptor("JMenuBar", new Object[] {
                 ...
                 sun.swing.BeanInfoUtils.SHORTDESCRIPTION, "The menubar for accessing pulldown menus from this frame.",
               }
             ),
             ...
             createPropertyDescriptor("contentPane", new Object[] {
                            sun.swing.BeanInfoUtils.BOUND, Boolean.FALSE,
                           sun.swing.BeanInfoUtils.HIDDEN, Boolean.TRUE,
                 sun.swing.BeanInfoUtils.SHORTDESCRIPTION, "The client area of the frame where child components are normally inserted.",
               }
             ),
             ...
             createPropertyDescriptor("defaultCloseOperation", new Object[] {
                 ...
                 sun.swing.BeanInfoUtils.SHORTDESCRIPTION, "The frame's default close operation.",
               }
             ),
             ...
             createPropertyDescriptor("layeredPane", new Object[] {
                            sun.swing.BeanInfoUtils.BOUND, Boolean.FALSE,
                           sun.swing.BeanInfoUtils.HIDDEN, Boolean.TRUE,
                 sun.swing.BeanInfoUtils.SHORTDESCRIPTION, "The pane that holds the various frame layers.",
               }
             ),
             ...
             createPropertyDescriptor("rootPane", new Object[] {
                            sun.swing.BeanInfoUtils.BOUND, Boolean.FALSE,
                           sun.swing.BeanInfoUtils.HIDDEN, Boolean.TRUE,
                 sun.swing.BeanInfoUtils.SHORTDESCRIPTION, "the RootPane object for this frame.",
               }
             ),
