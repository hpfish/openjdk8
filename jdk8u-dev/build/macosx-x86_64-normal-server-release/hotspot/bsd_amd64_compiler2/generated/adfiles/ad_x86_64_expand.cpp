...
const RegMask _NO_REG_mask( 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _ANY_REG_WITH_RBP_mask( 0xffffffff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _ANY_REG_NO_RBP_mask( 0xff3fffff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _PTR_REG_WITH_RBP_mask( 0xffffcff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _STACK_OR_PTR_REG_WITH_RBP_mask( 0xffffcff, 0x0, 0x0, 0x0, 0x0, 0xffffff00, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask _PTR_REG_NO_RBP_mask( 0xf3ffcff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _STACK_OR_PTR_REG_NO_RBP_mask( 0xf3ffcff, 0x0, 0x0, 0x0, 0x0, 0xffffff00, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask _PTR_NO_RAX_REG_WITH_RBP_mask( 0xfcffcff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _PTR_NO_RAX_REG_NO_RBP_mask( 0xf0ffcff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _PTR_NO_RAX_RBX_REG_WITH_RBP_mask( 0xfcfccff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _PTR_NO_RAX_RBX_REG_NO_RBP_mask( 0xf0fccff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
...
const RegMask _LONG_REG_WITH_RBP_mask( 0xffffcff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _STACK_OR_LONG_REG_WITH_RBP_mask( 0xffffcff, 0x0, 0x0, 0x0, 0x0, 0xffffff00, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask _LONG_REG_NO_RBP_mask( 0xf3ffcff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _STACK_OR_LONG_REG_NO_RBP_mask( 0xf3ffcff, 0x0, 0x0, 0x0, 0x0, 0xffffff00, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask _LONG_NO_RAX_RDX_REG_WITH_RBP_mask( 0xfccfcff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _LONG_NO_RAX_RDX_REG_NO_RBP_mask( 0xf0cfcff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _LONG_NO_RCX_REG_WITH_RBP_mask( 0xffff0ff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _LONG_NO_RCX_REG_NO_RBP_mask( 0xf3ff0ff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
...
const RegMask _INT_REG_WITH_RBP_mask( 0x5555455, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _STACK_OR_INT_REG_WITH_RBP_mask( 0x5555455, 0x0, 0x0, 0x0, 0x0, 0xffffff00, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask _INT_REG_NO_RBP_mask( 0x5155455, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _STACK_OR_INT_REG_NO_RBP_mask( 0x5155455, 0x0, 0x0, 0x0, 0x0, 0xffffff00, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask _INT_NO_RCX_REG_WITH_RBP_mask( 0x5555055, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _INT_NO_RCX_REG_NO_RBP_mask( 0x5155055, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _INT_NO_RAX_RDX_REG_WITH_RBP_mask( 0x5445455, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask _INT_NO_RAX_RDX_REG_NO_RBP_mask( 0x5045455, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
