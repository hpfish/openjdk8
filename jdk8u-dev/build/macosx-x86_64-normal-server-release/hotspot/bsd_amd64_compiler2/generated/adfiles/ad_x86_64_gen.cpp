...
MachNode *State::MachNodeGenerator(int opcode, Compile* C){
  ...
  case compUL_rReg_rule: {
      compUL_rRegNode *node = new (C) compUL_rRegNode();
      return node;
    }
  case compUL_rReg_imm_rule: {
      compUL_rReg_immNode *node = new (C) compUL_rReg_immNode();
      return node;
    }
  case compUL_rReg_mem_rule: {
      compUL_rReg_memNode *node = new (C) compUL_rReg_memNode();
      return node;
    }
  case testUL_reg_rule: {
      testUL_regNode *node = new (C) testUL_regNode();
      return node;
    }
  case minI_rReg_rule: {
